...
This is a sample template for opg-document-conversion-lambda - Below is a brief explanation of what we have generated for you:
...
sam deploy \
    ...
    --stack-name opg-document-conversion-lambda \
...
```bash
sam logs -n HelloWorldFunction --stack-name opg-document-conversion-lambda --tail
```
...
```bash
aws cloudformation delete-stack --stack-name opg-document-conversion-lambda
```
